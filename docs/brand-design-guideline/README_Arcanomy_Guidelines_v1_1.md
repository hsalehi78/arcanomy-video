...
## New: `Arcanomy_Examples_Pack_Spec_v1.md` — *Visual Proof Pack*
**Use when:** onboarding someone, debating a design decision, or training “good vs bad” taste.

Defines:
- the gold standard web screenshots
- the gold standard reel stills
- the “this vs that” training artifact
- the failure gallery (do-not-ship examples)
